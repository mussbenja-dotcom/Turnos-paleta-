 ...
 */
async function reservarTurno({ turnoId, clienteId, tipo = 'estandar', descripcion = null, monto = null }) {
  ...
  try {
    ...
    const res = await client.query(
      `INSERT INTO reservas (turno_id, cliente_id, tipo, descripcion, monto)
       VALUES ($1, $2, $3, $4, $5) RETURNING *`,
      [turnoId, clienteId, tipo, descripcion, monto]
    );
